...
namespace Euler
{
    ...
    public class EulerProblemEngine
    {
        ...
        private List<Problem> ProblemsToSolve = new List<Problem> { 
          ...
          new EulerProblem36(), new EulerProblem37(), new EulerProblem38(), new EulerProblem39(), new EulerProblem40(),
          new EulerProblem41(), new EulerProblem42(), new EulerProblem43(), new EulerProblem44(), new EulerProblem45(),
					new EulerProblem46(), new EulerProblem47(), new EulerProblem48(), new EulerProblem49(), new EulerProblem50(),
          new EulerProblem67() };
